...
#model
Mask1_decim005_degree2_lambda005 = Surface_Radiance.importFromFile_SH("Mask1_decim005_decim025_degree2_lambda005.ply"); #commence a 25%
...
Surface_Radiance.decimate(Mask1_decim005_degree2_lambda005.getName(), "position", "normal", 0.5, 1); #replace 0.5 by the percentage of decimation you want
...
Surface_Radiance.decimate(Mask1_decim005_degree2_lambda005.getName(), "position", "normal", 0.5, 1);
Surface_Radiance.computeRadianceDistance(Mask1_decim005_degree2_lambda005_1.getName(), "position", "normal", "distance", Mask1_decim005_degree2_lambda005.getName(), "position", "normal", "distance");
...
#Now let's compare with other models
Mask1_decim005_degree1_lambda005 = Surface_Radiance.importFromFile_SH("Mask1_decim005_degree1_lambda005.ply"); #HERE IS THE CPT_INSTANCES BUG
...
Surface_Radiance.computeRadianceDistance(Mask1_decim005_degree2_lambda005_1.getName(), "position", "normal", "distance", Mask1_decim005_degree1_lambda005.getName(), "position", "normal", "distance");
